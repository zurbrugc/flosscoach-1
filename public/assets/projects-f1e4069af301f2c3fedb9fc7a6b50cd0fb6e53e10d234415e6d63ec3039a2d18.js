...
// Example Tokenfield With Typeahead
  ...
  (function() {
    var engine = new Bloodhound({
      local: [
        {value :'browser'},{value :'chrome'},{value :'client'},{value :'css'},{value :'development'},{value :'firefox'},{value :'gecko'},{value :'gtk'},{value :'html'},{value :'http'},{value :'internet'},{value :'javascript'},{value :'mozilla'},{value :'web'},{value :'www'},{value :'xhtml'},{value :'xul'}
      ],
