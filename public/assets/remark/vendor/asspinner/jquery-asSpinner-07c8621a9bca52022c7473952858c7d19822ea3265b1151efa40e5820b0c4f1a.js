...
(function(global, factory) {
  ...
  function(_jquery) {
    ...
    var asSpinner = function() {
      ...
      _createClass(asSpinner, [{
        key: 'init',
        value: function init() {
          this.$control = (0, _jquery2.default)('<div class="' + this.namespace + '-control"><span class="' + this.classes.up + '"></span><span class="' + this.classes.down + '"></span></div>');
        ...
        value: function bindEvent() {
          ...
          this.$down.on('mousedown.asSpinner',
            ...
            function() {
              (0, _jquery2.default)(document).one('mouseup.asSpinner',
          ...
          this.$element.on('focus.asSpinner',
            ...
            function() {
              ...
              // keyboard support
              (0, _jquery2.default)(this).on('keydown.asSpinner',
              ...
              if (that.mousewheel === true) {
                (0, _jquery2.default)(this).mousewheel(
        ...
        value: function isNumber(value) {
          if (typeof value === 'number' && _jquery2.default.isNumeric(value)) {
        ...
        value: function update(obj) {
          ...
          ['min', 'max', 'precision', 'step'].forEach(
      ...
      return this.each(
        ...
        function() {
          if (!(0, _jquery2.default)(this).data(NAMESPACE)) {
            (0, _jquery2.default)(this).data(NAMESPACE, new asSpinner(this, options));
          }
        }
      );
    };
