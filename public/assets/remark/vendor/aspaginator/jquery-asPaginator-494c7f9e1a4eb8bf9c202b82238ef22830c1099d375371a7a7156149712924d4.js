  ...
  function(_jquery) {
    ...
    var AsPaginator = function() {
      ...
      _createClass(AsPaginator, [{
        ...
        value: function init() {
          ...
          _jquery2.default.each(this.options.components,
        ...
        value: function getVisible() {
          ...
          if (typeof this.options.visibleNum !== 'number') {
            _jquery2.default.each(this.options.visibleNum,
    ...
    AsPaginator.registerComponent('prev', {
      ...
      init: function init(instance) {
        var opts = _jquery2.default.extend({}, this.defaults, instance.options.components.prev);

        this.opts = opts;
      },
      bindEvents: function bindEvents(instance) {
        this.$prev = instance.$element.find('.' + instance.namespace + '-prev');
        this.$prev.on('click.asPaginator', _jquery2.default.proxy(instance.prev, instance));
      },
    ...
    AsPaginator.registerComponent('next', {
      ...
      init: function init(instance) {
        var opts = _jquery2.default.extend({}, this.defaults, instance.options.components.next);

        this.opts = opts;
      },
      bindEvents: function bindEvents(instance) {
        this.$next = instance.$element.find('.' + instance.namespace + '-next');
        this.$next.on('click.asPaginator', _jquery2.default.proxy(instance.next, instance));
      },
      unbindEvents: function unbindEvents() {
    ...
    AsPaginator.registerComponent('first', {
      ...
      init: function init(instance) {
        var opts = _jquery2.default.extend({}, this.defaults, instance.options.components.first);

        this.opts = opts;
      },
      bindEvents: function bindEvents(instance) {
        this.$first = instance.$element.find('.' + instance.namespace + '-first');
        this.$first.on('click.asPaginator', _jquery2.default.proxy(instance.goFirst, instance));
      },
      unbindEvents: function unbindEvents() {
    ...
    AsPaginator.registerComponent('last', {
      ...
      init: function init(instance) {
        var opts = _jquery2.default.extend({}, this.defaults, instance.options.components.last);

        this.opts = opts;
      },
      bindEvents: function bindEvents(instance) {
        this.$last = instance.$element.find('.' + instance.namespace + '-last');
        this.$last.on('click.asPaginator', _jquery2.default.proxy(instance.goLast, instance));
      },
      unbindEvents: function unbindEvents() {
    ...
    AsPaginator.registerComponent('lists', {
      ...
      init: function init(instance) {
        var opts = _jquery2.default.extend({}, this.defaults, instance.options.components.lists);
      ...
      bindEvents: function bindEvents(instance) {
        ...
        instance.$element.on('click', this.$items,

          function(e) {
            var page = (0, _jquery2.default)(e.target).parent().data('value') || (0, _jquery2.default)(e.target).data('value');
    ...
    AsPaginator.registerComponent('goTo', {
      ...
      init: function init(instance) {
        var opts = _jquery2.default.extend({}, this.defaults, instance.options.components.goTo);
    ...
    AsPaginator.registerComponent('altLists', {
      ...
      init: function init(instance) {
        var opts = _jquery2.default.extend({}, this.defaults, instance.options.components.altLists);
    ...
    AsPaginator.registerComponent('info', {
      ...
      init: function init(instance) {
        var opts = _jquery2.default.extend({}, this.defaults, instance.options.components.info);
    ...
    var jQueryAsPaginator = function jQueryAsPaginator(totalItems) {
      ...
      if (!_jquery2.default.isNumeric(totalItems) && typeof totalItems === 'string') {
        var _ret = function() {
      ...
      return this.each(
        ...
        function() {
          if (!(0, _jquery2.default)(this).data(NAMESPACE)) {
            (0, _jquery2.default)(this).data(NAMESPACE, new (Function.prototype.bind.apply(AsPaginator, [null].concat([this, totalItems], args)))());
          }
        }
      );
    };
