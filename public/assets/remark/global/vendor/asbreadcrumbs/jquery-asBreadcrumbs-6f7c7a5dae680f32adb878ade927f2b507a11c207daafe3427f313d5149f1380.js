      ...
      _createClass(asBreadcrumbs, [{
        ...
        value: function init() {
          ...
          if (this.options.responsive) {
            (0, _jquery2.default)(window).on(this.eventNameWithId('resize'), this._throttle(
        ...
        value: function _prepareItems() {
          ...
          this.$children.each(
            ...
            function() {
              ...
              var $dropdownItem = (0, _jquery2.default)(that.options.dropdownItem.call(that, that.classes, $this.text(), $link.attr('href')));
        ...
        value: function _createDropdown() {
          this.$dropdown = (0, _jquery2.default)(this.options.dropdown.call(this, this.classes)).addClass(this.classes.hiddenClass).appendTo(this.$element);
        ...
        value: function _createEllipsis() {
          ...
          this.$ellipsis = (0, _jquery2.default)(this.options.ellipsis.call(this, this.classes, this.options.ellipsisText)).addClass(this.classes.hiddenClass);
      ...
      if (typeof options === 'string') {
        var _ret = function() {
          ...
          if (/^_/.test(method)) {
            ...
            var instance = _this3.first().data(NAME);
      ...
      return this.each(
        ...
        function() {
          if (!(0, _jquery2.default)(this).data(NAME)) {
            (0, _jquery2.default)(this).data(NAME, new asBreadcrumbs(this, options));
          }
        }
      );
    };
